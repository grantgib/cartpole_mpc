function [f_linear, f_nonlinear,n_x, n_c, l_pole] = Generate_Cartpole_Dynamics(pinned,analytical)
...
if pinned
    ...
    B = [1; 0];
    ddq = D\(-C*dq-G+B*u_force);
    
    % Differential Equation for Dynamical System
    f_linear = Linear_Cartpole_ODE(x,u,dq,ddq,D,C,G,B,pinned,analytical);
    f_nonlinear = Nonlinear_Cartpole_ODE(x,u,dq,ddq,pinned);
