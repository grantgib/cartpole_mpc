function [x_traj,u_traj,dx_traj,du_traj,dx_traj_all,t_all,mpciter] = ...
...
while(mpciter < sim_time / DT)
    ...
    if nargin == 11 % regulator
        pause
        args = Update_Parameters(x_init,N,n_x,n_c,args,X_REF); % X_REF is one state
    else
        args = Update_Parameters(dx_init,N,n_x,n_c,args,X_REF,U_REF);
    end
